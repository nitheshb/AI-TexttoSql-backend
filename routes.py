...
from schema import (QueryRequest, QueryResponse, MySQLQueryRequest, PostgreSQLQueryRequest, 
    NeonDBQueryRequest, SupabaseQueryRequest, FirestoreQueryRequest)
...
async def postgresql_query(request: PostgreSQLQueryRequest):
    """
...
async def neon_query(request: NeonDBQueryRequest):
    """
    Process a natural language query, convert it to Postgresql query,
    execute it, and return the results in human-readable format.
    """
...
async def firestore_query(request: FirestoreQueryRequest):
    """
...
async def redefine_firestore_query(request: QueryRequest):
    """
    Process a natural language query, convert it to Firestore query code and execute it.
    """
...
async def redefine_supabase_query(request: QueryRequest):
    """
    Process a natural language query, convert it to Postgresql query and execute it.
    """
    try:
